from models.networks import Discriminator, Style_SpatialAttn_Reso2_En2_Decoder2
from StackGAN.models import STAGE1_G, STAGE2_G
import torch, os
...
def get_model_complexity_info(model, input_res, print_per_layer_stat=True, as_strings=True,
    ...
    if input_constructor:
        ...
        sentence = torch.FloatTensor(1, input_res[0]).cuda()
        noise = torch.FloatTensor(1, input_res[1]).cuda()
        _ = flops_model(sentence, noise)
...
with torch.cuda.device(0):
  # net = Style_SpatialAttn_Reso2_En2_Decoder2(embedding_dim=128, noise_dim=128, hidden_dim=1024).cuda()
  net1 = STAGE1_G().cuda()
  net = STAGE2_G(net1).cuda()
  flops, params = get_model_complexity_info(net, [1024, 100], as_strings=True, print_per_layer_stat=True)
  print('Flops:  ' + flops)
  print('Params: ' + params)